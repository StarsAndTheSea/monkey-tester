# Signal Lab — MVP Build Specification
...
- **Signal Lab** (clear, on-strategy; used as the working title here)
...
- Frame outputs as **findings about a hypothesis**, not recommendations. "This signal would have…"
  not "Buy these."
- Keep a persistent, plain footer: *"Signal Lab is a research tool for testing ideas. Nothing here is
